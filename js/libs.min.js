(!(function (e, t) {
  ...
  function g(e, t, i, n) {
    var s,
      ...
      c =
        e.nodeType &&
        (fe.cssNumber[t] || ("px" !== d && +l)) &&
        Ne.exec(fe.css(e, t));
    if (c && c[3] !== d) {
      for (l /= 2, d = d || c[3], c = +l || 1; a--; )
        (fe.style(e, t, c + d),
          (1 - o) * (1 - (o = r() / l || 0.5)) <= 0 && (a = 0),
          (c /= o));
      ((c *= 2), fe.style(e, t, c + d), (i = i || []));
    }
    return (
      i &&
        ((c = +c || +l || 0),
  ...
  function m(e, t) {
    for (var i, n, s, o, a, r, l, d = [], c = 0, u = e.length; c < u; c++)
      (n = e[c]).style &&
        ((i = n.style.display),
        t
          ? ("none" === i &&
              ((d[c] = ze.get(n, "display") || null),
              d[c] || (n.style.display = "")),
            "" === n.style.display &&
              Be(n) &&
              (d[c] =
                ...
                (r = s.nodeName),
                (l = We[r]) ||
                  ((o = a.body.appendChild(a.createElement(r))),
                  (l = fe.css(o, "display")),
                  o.parentNode.removeChild(o),
                  "none" === l && (l = "block"),
                  (We[r] = l)))))
          : "none" !== i && ((d[c] = "none"), ze.set(n, "display", i)));
  ...
  function b(e, t) {
    for (var i = 0, n = e.length; i < n; i++)
      ze.set(e[i], "globalEval", !t || ze.get(t[i], "globalEval"));
  }
  function w(e, t, i, s, o) {
    for (
      ...
      if ((a = e[f]) || 0 === a)
        if ("object" === n(a)) fe.merge(h, a.nodeType ? [a] : a);
        else if (Qe.test(a)) {
          for (
            r = r || p.appendChild(t.createElement("div")),
              l = (Ve.exec(a) || ["", ""])[1].toLowerCase(),
              d = _e[l] || _e._default,
              r.innerHTML = d[1] + fe.htmlPrefilter(a) + d[2],
              u = d[0];
            u--;

          )
            r = r.lastChild;
          (fe.merge(h, r.childNodes), ((r = p.firstChild).textContent = ""));
        } else h.push(t.createTextNode(a));
    for (p.textContent = "", f = 0; (a = h[f++]); )
      if (s && -1 < fe.inArray(a, s)) o && o.push(a);
      else if (((c = qe(a)), (r = y(p.appendChild(a), "script")), c && b(r), i))
        for (u = 0; (a = r[u++]); ) Ge.test(a.type || "") && i.push(a);
    return p;
  }
  function x() {
    return !0;
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (o)
                ...
                return (e.stopImmediatePropagation(), e.preventDefault(), s);
            } else
              o &&
                (ze.set(
                  this,
                  t,
                  fe.event.trigger(
                    fe.extend(o.shift(), fe.Event.prototype),
                    o,
                    this,
                  ),
                ),
  ...
  function M(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        ze.hasData(e) &&
        ((o = ze.access(e)), (a = ze.set(t, o)), (d = o.events))
      )
        for (s in (delete a.handle, (a.events = {}), d))
          for (i = 0, n = d[s].length; i < n; i++) fe.event.add(t, s, d[s][i]);
      De.hasData(e) &&
        ((r = De.access(e)), (l = fe.extend({}, r)), De.set(t, l));
    }
  }
  function L(e, t, n, s) {
    t = te.apply([], t);
    var o,
      ...
      f = t[0],
      v = ce(f);
    if (v || (1 < p && "string" == typeof f && !de.checkClone && nt.test(f)))
      return e.each(function (i) {
        var o = e.eq(i);
        (v && (t[0] = f.call(this, i, o.html())), L(o, t, n, s));
      });
    if (
      p &&
      ((a = (o = w(t, e[0].ownerDocument, !1, e, s)).firstChild),
      1 === o.childNodes.length && (o = a),
      a || s)
    ) {
      for (l = (r = fe.map(y(o, "script"), $)).length; u < p; u++)
        ((d = o),
          u !== h &&
            ((d = fe.clone(d, !0, !0)), l && fe.merge(r, y(d, "script"))),
          n.call(e[u], d, u));
      if (l)
        for (c = r[r.length - 1].ownerDocument, fe.map(r, P), u = 0; u < l; u++)
          ((d = r[u]),
            Ge.test(d.type || "") &&
              !ze.access(d, "globalEval") &&
              fe.contains(c, d) &&
              (d.src && "module" !== (d.type || "").toLowerCase()
                ...
                : i(d.textContent.replace(st, ""), d, c)));
    }
    return e;
  }
  function A(e, t, i) {
    for (var n, s = t ? fe.filter(t, e) : e, o = 0; null != (n = s[o]); o++)
      (i || 1 !== n.nodeType || fe.cleanData(y(n)),
        n.parentNode &&
          (i && qe(n) && b(y(n, "script")), n.parentNode.removeChild(n)));
    return e;
  }
  function z(e, t, i) {
    var n,
    ...
    return (
      ...
      (e in dt
        ...
        : (ct[e] =
            (function (e) {
              for (
                var t = e[0].toUpperCase() + e.slice(1), i = lt.length;
                i--;

              )
                if ((e = lt[i] + t) in dt) return e;
            })(e) || e))
    );
  }
  function O(e, t, i) {
  ...
  function H(e, t, i, n, s, o) {
    ...
    for (; a < 4; a += 2)
      ("margin" === i && (l += fe.css(e, i + je[a], !0, s)),
        n
          ? ("content" === i && (l -= fe.css(e, "padding" + je[a], !0, s)),
            "margin" !== i &&
              (l -= fe.css(e, "border" + je[a] + "Width", !0, s)))
          : ((l += fe.css(e, "padding" + je[a], !0, s)),
            "padding" !== i
              ? (l += fe.css(e, "border" + je[a] + "Width", !0, s))
              : (r += fe.css(e, "border" + je[a] + "Width", !0, s))));
    return (
      !n &&
        0 <= o &&
        (l +=
          Math.max(
            0,
            Math.ceil(
              e["offset" + t[0].toUpperCase() + t.slice(1)] - o - l - r - 0.5,
            ),
          ) || 0),
      l
    );
  ...
  function N(e, t, i) {
    var n = at(e),
      s =
        (!de.boxSizingReliable() || i) &&
        "border-box" === fe.css(e, "boxSizing", !1, n),
      o = s,
      a = z(e, t, n),
    ...
    return (
      ((!de.boxSizingReliable() && s) ||
        "auto" === a ||
        (!parseFloat(a) && "inline" === fe.css(e, "display", !1, n))) &&
        e.getClientRects().length &&
        ((s = "border-box" === fe.css(e, "boxSizing", !1, n)),
        (o = r in e) && (a = e[r])),
      (a = parseFloat(a) || 0) +
        H(e, t, i || (s ? "border" : "content"), o, n, a) +
        "px"
    );
  }
  ...
  function R(e, t) {
    ...
    for (t = t ? 1 : 0; n < 4; n += 2 - t)
      s["margin" + (i = je[n])] = s["padding" + i] = e;
    return (t && (s.opacity = s.width = e), s);
  }
  function B(e, t, i) {
    for (
      var n,
        s = (X.tweeners[t] || []).concat(X.tweeners["*"]),
        o = 0,
        a = s.length;
      o < a;
      o++
  ...
  function X(e, t, i) {
    var n,
      ...
      l = function () {
        ...
        for (
          ...
          d.tweens[o].run(n);
        return (
          r.notifyWith(e, [d, n, i]),
          n < 1 && a
            ? i
            : (a || r.notifyWith(e, [d, 1, 0]), r.resolveWith(e, [d]), !1)
        );
      },
      d = r.promise({
        elem: e,
        ...
        stop: function (t) {
          ...
          return (
            t
              ? (r.notifyWith(e, [d, 1, 0]), r.resolveWith(e, [d, t]))
              : r.rejectWith(e, [d, t]),
            this
          );
        },
    ...
    for (
      ...
      if ((n = X.prefilters[o].call(d, e, c, d.opts)))
        return (
          ce(n.stop) &&
            (fe._queueHooks(d.elem, d.opts.queue).stop = n.stop.bind(n)),
          n
        );
    return (
      fe.map(c, B, d),
  ...
  ((fe.fn = fe.prototype =
    ...
    (fe.extend = fe.fn.extend =
      function () {
        var e,
          ...
          d = !1;
        for (
          "boolean" == typeof a && ((d = a), (a = arguments[r] || {}), r++),
          ...
          if (null != (e = arguments[r]))
            for (t in e)
              ((n = e[t]),
                "__proto__" !== t &&
                  a !== n &&
                  (d && n && (fe.isPlainObject(n) || (s = Array.isArray(n)))
                    ? ((i = a[t]),
                      (o =
                        s && !Array.isArray(i)
                          ? []
                          : s || fe.isPlainObject(i)
                            ? i
                            : {}),
                      (s = !1),
                      (a[t] = fe.extend(d, o, n)))
    ...
    fe.extend({
      ...
      isPlainObject: function (e) {
        ...
        return !(
          ...
          ((t = J(e)) &&
            ("function" !=
              typeof (i = ae.call(t, "constructor") && t.constructor) ||
              re.call(i) !== le))
        );
      },
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (s(Object(e))
              ? fe.merge(i, "string" == typeof e ? [e] : e)
              : ie.call(i, e)),
          i
        );
      },
      ...
      map: function (e, t, i) {
        ...
        else for (a in e) null != (o = t(e[a], a, i)) && r.push(o);
        return te.apply([], r);
      },
      guid: 1,
      support: de,
    ...
    "function" == typeof Symbol &&
      (fe.fn[Symbol.iterator] = Q[Symbol.iterator]),
    fe.each(
  ...
  var ge = (function (e) {
    function t(e, t, i, n) {
      ...
      if (
        !n &&
        ((t ? t.ownerDocument || t : F) !== A && L(t), (t = t || A), D)
      ) {
        if (11 !== f && (l = me.exec(e)))
          if ((s = l[1])) {
            if (9 === f) {
            ...
            } else if (p && (a = p.getElementById(s)) && N(t, a) && a.id === s)
              return (i.push(a), i);
          } else {
            ...
            if (
              ...
              return (Q.apply(i, t.getElementsByClassName(s)), i);
          }
        if (
          w.qsa &&
          !Y[e + " "] &&
          ...
          if (((c = e), (p = t), 1 === f && de.test(e))) {
            for (
              (r = t.getAttribute("id"))
                ? (r = r.replace(xe, Te))
                : t.setAttribute("id", (r = j)),
                o = (d = C(e)).length;
              o--;

            )
              d[o] = "#" + r + " " + h(d[o]);
            ((c = d.join(",")), (p = (ye.test(e) && u(t.parentNode)) || t));
          }
          try {
            return (Q.apply(i, p.querySelectorAll(c)), i);
          } catch (t) {
            Y(e, !0);
          } finally {
              ...
              for (; (t = t[n]); )
                if (1 === t.nodeType || a)
                  if (
                    ...
                    if ((d = c[o]) && d[0] === q && d[1] === r)
                      return (p[2] = d[2]);
                    if (((c[o] = p)[2] = e(t, i, l))) return !0;
                  }
            return !1;
          };
    }
    ...
    function g(e, t, i, n, s) {
      for (var o, a = [], r = 0, l = e.length, d = null != t; r < l; r++)
        (o = e[r]) && ((i && !i(o, n, s)) || (a.push(o), d && t.push(r)));
      return a;
    }
    function m(e, i, s, o, a, r) {
      return (
        o && !o[j] && (o = m(o)),
        a && !a[j] && (a = m(a, r)),
        n(function (n, r, l, d) {
          var c,
            ...
            y = !e || (!n && i) ? m : g(m, h, e, l, d),
            b = s ? (a || (n ? e : v || o) ? [] : r) : y;
          if ((s && s(y, b, l, d), o))
            for (c = g(b, f), o(c, [], l, d), u = c.length; u--; )
              (p = c[u]) && (b[f[u]] = !(y[f[u]] = p));
          if (n) {
            if (a || e) {
              if (a) {
            ...
            ((b = g(b === r ? b.splice(v, b.length) : b)),
              a ? a(null, r, b, d) : Q.apply(r, b));
        })
      );
    }
    function y(e) {
      for (
        ...
        if ((i = x.relative[e[r].type])) c = [f(v(c), i)];
        else {
          if ((i = x.filter[e[r].type].apply(null, e[r].matches))[j]) {
            for (n = ++r; n < s && !x.relative[e[n].type]; n++);
            return m(
              1 < r && v(c),
              1 < r &&
                h(
    ...
    try {
      (Q.apply((_ = Z.call(F.childNodes)), F.childNodes),
        _[F.childNodes.length].nodeType);
    } catch (b) {
      Q = {
        apply: _.length
          ? function (e, t) {
    ...
    (S = t.isXML =
      function (e) {
        ...
        return !he.test(t || (i && i.nodeName) || "HTML");
      }),
    (L = t.setDocument =
      function (e) {
        var t,
        ...
        return (
          n !== A &&
            ...
            (O = []),
            (I = []),
            (w.qsa = ge.test(A.querySelectorAll)) &&
              (s(function (e) {
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!w.sortDetached && t.compareDocumentPosition(e) === i)
                      ? e === A || (e.ownerDocument === F && N(F, e))
                        ? -1
                        : t === A || (t.ownerDocument === F && N(F, t))
                          ? 1
                          : P
                            ? J(P, e) - J(P, t)
                            : 0
    ...
    (t.matchesSelector = function (e, i) {
      ...
      return 0 < t(i, A, null, [e]).length;
    }),
    (t.contains = function (e, t) {
      return ((e.ownerDocument || e) !== A && L(e), N(e, t));
    }),
    (t.attr = function (e, t) {
      (e.ownerDocument || e) !== A && L(e);
      var i = x.attrHandle[t.toLowerCase()],
        n = i && G.call(x.attrHandle, t.toLowerCase()) ? i(e, t, !D) : void 0;
      return void 0 !== n
        ? n
        : w.attributes || !D
          ? e.getAttribute(t)
                    ...
                    if (((f = [a ? g.firstChild : g.lastChild]), a && y)) {
                      ...
                      (y &&
                        (b = h =
                          (d =
                            (c =
                              (u = (p = t)[j] || (p[j] = {}))[p.uniqueID] ||
                              (u[p.uniqueID] = {}))[e] || [])[0] === q && d[1]),
                      !1 === b)
                    )
                      for (
                        ;
    ...
    return (
      ...
      (C = t.tokenize =
        function (e, i) {
          ...
          for (r = e, l = [], d = x.preFilter; r; ) {
            for (a in ((n && !(s = re.exec(r))) ||
              (s && (r = r.slice(s[0].length) || r), l.push((o = []))),
            (n = !1),
            (s = le.exec(r)) &&
              ((n = s.shift()),
              o.push({ value: n, type: s[0].replace(ae, " ") }),
              (r = r.slice(n.length))),
            x.filter))
              !(s = pe[a].exec(r)) ||
                (d[a] && !(s = d[a](s))) ||
          ...
          return i ? r.length : r ? t.error(e) : X(e, l).slice(0);
        }),
      (E = t.compile =
        function (e, i) {
          var s,
            ...
            p = W[e + " "];
          if (!p) {
            for (i || (i = C(e)), s = i.length; s--; )
              (p = y(i[s]))[j] ? c.push(p) : u.push(p);
            (p = W(
              e,
              ((o = u),
              (r = 0 < (a = c).length),
              (l = 0 < o.length),
              (d = function (e, i, n, s, d) {
                var c,
                  u,
                  p,
                  h = 0,
                ...
                for (
                  ...
                  if (l && c) {
                    for (
                      u = 0, i || c.ownerDocument === A || (L(c), (n = !D));
                      (p = o[u++]);
                  ...
                  r && ((c = !p && c) && h--, e && v.push(c));
                }
                if (((h += f), r && f !== h)) {
                  for (u = 0; (p = a[u++]); ) p(v, m, i, n);
                  if (e) {
                    if (0 < h) for (; f--; ) v[f] || m[f] || (m[f] = U.call(s));
                    m = g(m);
                  }
                  (Q.apply(s, m),
                    d &&
        ...
        function (e, t, i, n) {
          ...
          if (((i = i || []), 1 === c.length)) {
            if (
              ...
              if (!(t = (x.find.ID(a.matches[0].replace(be, we), t) || [])[0]))
                return i;
              (d && (t = t.parentNode), (e = e.slice(o.shift().value.length)));
            }
            for (
              s = pe.needsContext.test(e) ? 0 : o.length;
              s-- && ((a = o[s]), !x.relative[(r = a.type)]);
              ...
              if (
                ...
                if ((o.splice(s, 1), !(e = n.length && h(o))))
        ...
        if ("string" != typeof e)
          return this.pushStack(
            fe(e).filter(function () {
              for (t = 0; t < n; t++) if (fe.contains(s[t], this)) return !0;
            }),
          );
    ...
    if (((i = i || xe), "string" == typeof e)) {
      ...
      if (n[1]) {
        if (
          ...
          fe.merge(
            this,
            fe.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : Z, !0),
          ),
          we.test(n[1]) && fe.isPlainObject(t))
        )
          for (n in t) ce(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
        return this;
      }
      return (
        (s = Z.getElementById(n[2])) && ((this[0] = s), (this.length = 1)),
        this
      );
    }
    return e.nodeType
        ...
        for (; n < s; n++)
          for (i = this[n]; i && i !== t; i = i.parentNode)
            if (
              ...
              (a
                ? -1 < a.index(i)
                : 1 === i.nodeType && fe.find.matchesSelector(i, e))
            ) {
              o.push(i);
              break;
            }
    ...
    fe.each(
      ...
      function (e, t) {
        fe.fn[e] = function (i, n) {
          ...
          return (
            "Until" !== e.slice(-5) && (n = i),
            n && "string" == typeof n && (s = fe.filter(n, s)),
            1 < this.length &&
              (Ce[e] || fe.uniqueSort(s), Se.test(e) && s.reverse()),
            this.pushStack(s)
          );
        };
      },
  ...
  ((fe.Callbacks = function (e) {
    ...
    e =
      "string" == typeof e
        ? ((t = e),
          (i = {}),
          fe.each(t.match(Ee) || [], function (e, t) {
            i[t] = !0;
          }),
          i)
        : fe.extend({}, e);
    var s,
      ...
      c = -1,
      u = function () {
        for (r = r || e.once, a = s = !0; d.length; c = -1)
          for (o = d.shift(); ++c < l.length; )
            !1 === l[c].apply(o[0], o[1]) &&
              e.stopOnFalse &&
              ((c = l.length), (o = !1));
        (e.memory || (o = !1), (s = !1), r && (l = o ? [] : ""));
      },
      p = {
        add: function () {
          return (
            l &&
              (o && !s && ((c = l.length - 1), d.push(o)),
              (function t(i) {
                fe.each(i, function (i, s) {
                  ce(s)
                    ? (e.unique && p.has(s)) || l.push(s)
        ...
        remove: function () {
          return (
            fe.each(arguments, function (e, t) {
              for (var i; -1 < (i = fe.inArray(t, l, i)); )
                (l.splice(i, 1), i <= c && c--);
            }),
            this
          );
    ...
    fe.extend({
        ...
        var i = [
          ...
          s = {
            ...
            then: function (t, n, s) {
                    ...
                    u = function () {
                      ...
                      if (!(t < a)) {
                        ...
                        ((u =
                          ...
                          ce(u)
                            ? s
                              ? u.call(e, o(a, i, l, s), o(a, i, d, s))
                              : (a++,
                                u.call(
                                  e,
                                  o(a, i, l, s),
                                  o(a, i, d, s),
                                  o(a, i, l, i.notifyWith),
                                ))
                            : (n !== l && ((r = void 0), (c = [e])),
                              (s || i.resolveWith)(r, c)));
                      }
              ...
              return fe
                .Deferred(function (e) {
                  (i[0][3].add(o(0, e, ce(s) ? s : l, e.notifyWith)),
                    i[1][3].add(o(0, e, ce(t) ? t : l)),
                    i[2][3].add(o(0, e, ce(n) ? n : d)));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (c(e, o.done(a(i)).resolve, o.reject, !t),
          "pending" === o.state() || ce(s[i] && s[i].then))
        )
          return o.then();
  ...
  var Pe = function (e, t, i, s, o, a, r) {
      ...
      if ("object" === n(i))
        ...
        for (; l < d; l++) t(e[l], i, r ? s : s.call(e[l], l, t(e[l], i)));
      return o ? e : c ? t.call(e) : d ? t(e[0], i) : a;
    },
    Me = /^-ms-/,
    Le = /-([a-z])/g,
    Ae = function (e) {
  ...
  ((f.uid = 1),
    (f.prototype = {
      ...
      set: function (e, t, i) {
        var n,
          s = this.cache(e);
        if ("string" == typeof t) s[h(t)] = i;
        else for (n in t) s[h(n)] = t[n];
        return s;
      },
      get: function (e, t) {
        return void 0 === t
  ...
  (fe.extend({
    hasData: function (e) {
      return De.hasData(e) || ze.hasData(e);
    },
    data: function (e, t, i) {
    ...
    fe.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((s = De.get(o)), 1 === o.nodeType && !ze.get(o, "hasDataAttrs"))
          ) {
            for (i = a.length; i--; )
              a[i] &&
                0 === (n = a[i].name).indexOf("data-") &&
                ((n = h(n.slice(5))), v(o, n, s[n]));
      ...
      queue: function (e, t, i) {
        ...
        if (e)
          return (
            ...
            i &&
              (!n || Array.isArray(i)
                ? (n = ze.access(e, t, fe.makeArray(i)))
                : n.push(i)),
            n || []
          );
      },
  ...
  Fe.attachShadow &&
    (qe = function (e) {
      return (
        fe.contains(e.ownerDocument, e) || e.getRootNode(Re) === e.ownerDocument
      );
    });
  var Be = function (e, t) {
      return (
        "none" === (e = t || e).style.display ||
        ("" === e.style.display && qe(e) && "none" === fe.css(e, "display"))
      );
    },
    Xe = function (e, t, i, n) {
      var s,
  ...
  var Ue,
    Ke,
    Qe = /<|&#?\w+;/;
  ((Ue = Z.createDocumentFragment().appendChild(Z.createElement("div"))),
    (Ke = Z.createElement("input")).setAttribute("type", "radio"),
    Ke.setAttribute("checked", "checked"),
    Ke.setAttribute("name", "t"),
    Ue.appendChild(Ke),
    (de.checkClone = Ue.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (Ue.innerHTML = "<textarea>x</textarea>"),
    (de.noCloneChecked = !!Ue.cloneNode(!0).lastChild.defaultValue));
  var Ze = /^key/,
  ...
  ((fe.event = {
      ...
      if (g)
        for (
          i.handler && ((i = (o = i).handler), (s = o.selector)),
            s && fe.find.matchesSelector(Fe, s),
          ...
          if (
            ...
            a &&
              ...
              ((u.teardown && !1 !== u.teardown.call(e, f, g.handle)) ||
                fe.removeEvent(e, h, g.handle),
              delete l[h]);
          } else for (h in l) fe.event.remove(e, h + t[d], i, n, !0);
    ...
    dispatch: function (e) {
      var t,
        ...
        d = (ze.get(this, "events") || {})[r.type] || [],
        c = fe.event.special[r.type] || {};
      for (l[0] = r, t = 1; t < arguments.length; t++) l[t] = arguments[t];
      if (
        ((r.delegateTarget = this),
        !c.preDispatch || !1 !== c.preDispatch.call(this, r))
      ) {
        for (
          a = fe.event.handlers.call(this, r, d), t = 0;
          ...
          if (1 === d.nodeType && ("click" !== e.type || !0 !== d.disabled)) {
            for (o = [], a = {}, i = 0; i < l; i++)
              (void 0 === a[(s = (n = t[i]).selector + " ")] &&
                (a[s] = n.needsContext
                  ? -1 < fe(s, this).index(d)
                  : fe.find(s, this, null, [d]).length),
                a[s] && o.push(n));
            o.length && r.push({ elem: d, handlers: o });
          }
      return (
        (d = this),
        l < t.length && r.push({ elem: d, handlers: t.slice(l) }),
        r
      );
    },
  ...
  (fe.extend({
    ...
    clone: function (e, t, i) {
      ...
      if (
        ...
        for (a = y(c), n = 0, s = (o = y(e)).length; n < s; n++)
          ((r = o[n]),
            (l = a[n]),
            "input" === (d = l.nodeName.toLowerCase()) && Ye.test(r.type)
              ? (l.checked = r.checked)
              : ("input" !== d && "textarea" !== d) ||
                (l.defaultValue = r.defaultValue));
      if (t)
        if (i)
          for (o = o || y(e), a = a || y(c), n = 0, s = o.length; n < s; n++)
            M(o[n], a[n]);
        else M(e, c);
      return (0 < (a = y(c, "script")).length && b(a, !u && y(e, "script")), c);
    },
    cleanData: function (e) {
      for (var t, i, n, s = fe.event.special, o = 0; void 0 !== (i = e[o]); o++)
        if (Ae(i)) {
          if ((t = i[ze.expando])) {
            if (t.events)
              for (n in t.events)
                s[n] ? fe.event.remove(i, n) : fe.removeEvent(i, n, t.handle);
            i[ze.expando] = void 0;
          }
          i[De.expando] && (i[De.expando] = void 0);
        }
    },
  }),
    fe.fn.extend({
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; i < n; i++)
                  1 === (t = this[i] || {}).nodeType &&
                    (fe.cleanData(y(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (t) {
            ...
            fe.inArray(this, e) < 0 &&
              (fe.cleanData(y(this)), i && i.replaceChild(t, this));
          },
          e,
        );
      },
    ...
    fe.each(
      ...
      function (e, t) {
        fe.fn[e] = function (e) {
          for (var i, n = [], s = fe(e), o = s.length - 1, a = 0; a <= o; a++)
  ...
  !(function () {
    function t() {
      if (d) {
        ((l.style.cssText =
          ...
          Fe.appendChild(l).appendChild(d));
    ...
    d.style &&
      ...
      (de.clearCloneStyle = "content-box" === d.style.backgroundClip),
      fe.extend(de, {
  ...
  (fe.extend({
    ...
    fe.each(["height", "width"], function (e, t) {
      fe.cssHooks[t] = {
        get: function (e, i, n) {
          if (i)
            return !ut.test(fe.css(e, "display")) ||
        ...
        set: function (e, i, n) {
          var s,
            o = at(e),
            a = !de.scrollboxSize() && "absolute" === o.position,
            r = (a || n) && "border-box" === fe.css(e, "boxSizing", !1, o),
            l = n ? H(e, t, n, r, o) : 0;
          return (
            r &&
              a &&
        ...
        return Pe(
          ...
          function (e, t, i) {
            var n,
              ...
              a = 0;
            if (Array.isArray(t)) {
              for (n = at(e), s = t.length; a < s; a++)
                o[t[a]] = fe.css(e, t[a], !1, n);
              return o;
            }
    ...
    (((fe.Tween = j).prototype = {
      ...
      init: function (e, t, i, n, s, o) {
        ((this.elem = e),
          (this.prop = i),
          (this.easing = s || fe.easing._default),
          (this.options = t),
      ...
      _default: {
        ...
        set: function (e) {
          fe.fx.step[e.prop]
            ? fe.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
                (!fe.cssHooks[e.prop] && null == e.elem.style[I(e.prop)])
              ? (e.elem[e.prop] = e.now)
  ...
  ((fe.Animation = fe.extend(X, {
    tweeners: {
      "*": [
        function (e, t) {
          ...
          return (g(i.elem, e, Ne.exec(t), i), i);
        },
      ],
    },
    ...
    prefilters: [
      function (e, t, i) {
        var n,
          ...
          g = ze.get(e, "fxshow");
        for (n in (i.queue ||
          (null == (a = fe._queueHooks(e, "fx")).unqueued &&
            ((a.unqueued = 0),
            (r = a.empty.fire),
        ...
        t))
          if (((s = t[n]), bt.test(s))) {
            ...
            h[n] = (g && g[n]) || fe.style(e, n);
          }
        if ((l = !fe.isEmptyObject(t)) || !fe.isEmptyObject(h))
          for (n in (u &&
            1 === e.nodeType &&
            ((i.overflow = [f.overflow, f.overflowX, f.overflowY]),
            null == (d = g && g.display) && (d = ze.get(e, "display")),
            "none" === (c = fe.css(e, "display")) &&
              (d
                ? (c = d)
                : (m([e], !0),
                  (d = e.style.display || d),
          ...
          h))
            (l ||
              (g
                ...
                : (g = ze.access(e, "fxshow", { display: d })),
              o && (g.hidden = !v),
              v && m([e], !0),
              p.done(function () {
                for (n in (v || m([e]), ze.remove(e, "fxshow"), h))
                  fe.style(e, n, h[n]);
              })),
              (l = B(v ? g[n] : 0, n, p)),
              n in g ||
      ...
      return (
        fe.fx.off
          ...
          : "number" != typeof n.duration &&
            (n.duration in fe.fx.speeds
              ? (n.duration = fe.fx.speeds[n.duration])
              : (n.duration = fe.fx.speeds._default)),
    ...
    fe.fn.extend({
      ...
      animate: function (e, t, i, n) {
        var s = fe.isEmptyObject(e),
          o = fe.speed(t, i, n),
          a = function () {
            var t = X(this, fe.extend({}, e), o);
            (s || ze.get(this, "finish")) && t.stop(!0);
          };
        return (
          (a.finish = a),
      ...
      stop: function (e, t, i) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (s in a) a[s] && a[s].stop && wt.test(s) && n(a[s]);
            for (s = o.length; s--; )
              o[s].elem !== this ||
                (null != e && o[s].queue !== e) ||
    ...
    (mt = Z.createElement("input")),
    (yt = Z.createElement("select").appendChild(Z.createElement("option"))),
    (mt.type = "checkbox"),
    (de.checkOn = "" !== mt.value),
    (de.optSelected = yt.selected),
    ((mt = Z.createElement("input")).value = "t"),
    (mt.type = "radio"),
    (de.radioValue = "t" === mt.value));
  var xt,
    Tt = fe.expr.attrHandle;
  (fe.fn.extend({
    attr: function (e, t) {
      return Pe(this, fe.attr, e, t, 1 < arguments.length);
    },
    ...
    fe.extend({
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && fe.isXMLDoc(e)) ||
                (s =
                  ...
                  (fe.expr.match.bool.test(t) ? xt : void 0)),
              void 0 !== i
                ? null === i
      ...
      attrHooks: {
        type: {
          set: function (e, t) {
            if (!de.radioValue && "radio" === t && o(e, "input")) {
              var i = e.value;
  ...
  (fe.fn.extend({
    prop: function (e, t) {
      return Pe(this, fe.prop, e, t, 1 < arguments.length);
    },
    ...
    fe.extend({
      prop: function (e, t, i) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && fe.isXMLDoc(e)) ||
              ((t = fe.propFix[t] || t), (s = fe.propHooks[t])),
            void 0 !== i
              ? s && "set" in s && void 0 !== (n = s.set(e, i, t))
                ? n
                : (e[t] = i)
    ...
    fe.fn.extend({
      addClass: function (e) {
        ...
        if ((t = V(e)).length)
          for (; (i = this[l++]); )
            if (((s = Y(i)), (n = 1 === i.nodeType && " " + W(s) + " "))) {
              for (a = 0; (o = t[a++]); )
                n.indexOf(" " + o + " ") < 0 && (n += o + " ");
              s !== (r = W(n)) && i.setAttribute("class", r);
            }
        return this;
      },
        ...
        return "boolean" == typeof t && n
          ...
          : ce(e)
            ? this.each(function (i) {
                fe(this).toggleClass(e.call(this, i, Y(this), t), t);
              })
            : this.each(function () {
                var t, s, o, a;
                if (n)
                  for (s = 0, o = fe(this), a = V(e); (t = a[s++]); )
                    o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else
                  (void 0 !== e && "boolean" !== i) ||
                    ((t = Y(this)) && ze.set(this, "__className__", t),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        t || !1 === e
      ...
      hasClass: function (e) {
        var t,
          ...
          n = 0;
        for (t = " " + e + " "; (i = this[n++]); )
          if (1 === i.nodeType && -1 < (" " + W(Y(i)) + " ").indexOf(t))
            return !0;
        return !1;
      },
    }));
      ...
      return arguments.length
        ? ((n = ce(e)),
          this.each(function (i) {
            var s;
            1 === this.nodeType &&
              (null == (s = n ? e.call(this, i, fe(this).val()) : e)
                ? (s = "")
                : "number" == typeof s
                  ? (s += "")
                  : Array.isArray(s) &&
                    (s = fe.map(s, function (e) {
                      return null == e ? "" : e + "";
                    })),
              ((t =
        ...
        : s
          ? (t =
              fe.valHooks[s.type] || fe.valHooks[s.nodeName.toLowerCase()]) &&
            "get" in t &&
    ...
    fe.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var i, n, s = e.options, o = fe.makeArray(t), a = s.length;
              a--;

            )
              ((n = s[a]).selected =
                -1 < fe.inArray(fe.valHooks.option.get(n), o)) && (i = !0);
  ...
  (fe.extend(fe.event, {
    trigger: function (t, i, n, s) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !kt.test(f + fe.event.triggered) &&
          (-1 < f.indexOf(".") && ((f = (v = f.split(".")).shift()), v.sort()),
          (d = f.indexOf(":") < 0 && "on" + f),
          ((t = t[fe.expando]
            ? t
            : new fe.Event(f, "object" == typeof t && t)).isTrigger = s
            ? 2
            : 3),
          (t.namespace = v.join(".")),
        ...
        if (!s && !u.noBubble && !ue(n)) {
          for (
            l = u.delegateType || f, kt.test(l + f) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            (h.push(a), (r = a));
        ...
        for (o = 0; (a = h[o++]) && !t.isPropagationStopped(); )
          ((p = a),
            (t.type = 1 < o ? l : u.bindType || f),
            (c = (ze.get(a, "events") || {})[t.type] && ze.get(a, "handle")) &&
              c.apply(a, i),
            (c = d && a[d]) &&
              c.apply &&
              Ae(a) &&
        ...
        return (
          ...
          s ||
            ...
            (u._default && !1 !== u._default.apply(h.pop(), i)) ||
            !Ae(n) ||
            (d &&
              ce(n[f]) &&
              !ue(n) &&
              ...
              t.isPropagationStopped() && p.addEventListener(f, $t),
              n[f](),
              t.isPropagationStopped() && p.removeEventListener(f, $t),
        ...
        fe.event.special[t] = {
          setup: function () {
            var n = this.ownerDocument || this,
              s = ze.access(n, t);
            (s || n.addEventListener(e, i, !0), ze.access(n, t, (s || 0) + 1));
          },
          teardown: function () {
            var n = this.ownerDocument || this,
              s = ze.access(n, t) - 1;
            s
              ? ze.access(n, t, s)
              : (n.removeEventListener(e, i, !0), ze.remove(n, t));
          },
        };
      }));
  var Pt = e.location,
    ...
    fe.extend({
      ...
      ajax: function (t, i) {
        function n(t, i, n, r) {
          ...
          c ||
            ...
            n &&
              (w = (function (e, t, i) {
                for (
                  var n, s, o, a, r = e.contents, l = e.dataTypes;
                  "*" === l[0];
            ...
            d
              ? (f.ifModified &&
                  ((x = S.getResponseHeader("Last-Modified")) &&
                    (fe.lastModified[o] = x),
                  (x = S.getResponseHeader("etag")) && (fe.etag[o] = x)),
                204 === t || "HEAD" === f.type
                  ? (T = "nocontent")
                  : 304 === t
                    ? (T = "notmodified")
                    : ((T = w.state), (p = w.data), (d = !(h = w.error))))
              : ((h = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
            (S.status = t),
            (S.statusText = (i || T) + ""),
            d ? m.resolveWith(v, [p, T, S]) : m.rejectWith(v, [S, T, h]),
            S.statusCode(b),
            (b = void 0),
            u && g.trigger(d ? "ajaxSuccess" : "ajaxError", [S, f, d ? p : h]),
            y.fireWith(v, [S, T]),
            u &&
        ...
        var s,
          ...
          f = fe.ajaxSetup({}, i),
          v = f.context || f,
          g = f.context && (v.nodeType || v.jquery) ? fe(v) : fe.event,
          m = fe.Deferred(),
        ...
        if (
          ...
          try {
            ((d.href = f.url),
              (d.href = d.href),
              (f.crossDomain =
                Wt.protocol + "//" + Wt.host != d.protocol + "//" + d.host));
          } catch (t) {
            f.crossDomain = !0;
          }
        }
        if (
          (f.data &&
            ...
            (f.data = fe.param(f.data, f.traditional)),
          U(Rt, f, i, S),
          c)
        )
          return S;
        for (p in ((u = fe.event && f.global) &&
          0 == fe.active++ &&
          fe.event.trigger("ajaxStart"),
        ...
        f.hasContent
          ...
          : ((h = f.url.slice(o.length)),
            f.data &&
              ...
              ((o += (Lt.test(o) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((o = o.replace(Nt, "$1")),
              (h = (Lt.test(o) ? "&" : "?") + "_=" + Mt++ + h)),
            (f.url = o + h)),
        f.ifModified &&
          (fe.lastModified[o] &&
            S.setRequestHeader("If-Modified-Since", fe.lastModified[o]),
          fe.etag[o] && S.setRequestHeader("If-None-Match", fe.etag[o])),
        ...
        if (
          ...
          if (((S.readyState = 1), u && g.trigger("ajaxSend", [S, f]), c))
            return S;
          f.async &&
            0 < f.timeout &&
  ...
  ((de.cors = !!Vt && "withCredentials" in Vt),
    (de.ajax = Vt = !!Vt),
    fe.ajaxTransport(function (t) {
      var i, n;
      if (de.cors || (Vt && !t.crossDomain))
        return {
          send: function (s, o) {
            var a,
              r = t.xhr();
  ...
  (fe.ajaxSetup({
    ...
    fe.ajaxPrefilter("json jsonp", function (t, i, n) {
      ...
      if (r || "jsonp" === t.dataTypes[0])
        return (
          (s = t.jsonpCallback =
            ce(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
          r
            ? (t[r] = t[r].replace(Ut, "$1" + s))
            : !1 !== t.jsonp &&
              (t.url += (Lt.test(t.url) ? "&" : "?") + t.jsonp + "=" + s),
          (t.converters["script json"] = function () {
            return (a || fe.error(s + " was not called"), a[0]);
          }),
          (t.dataTypes[0] = "json"),
          (o = e[s]),
          (e[s] = function () {
          ...
          n.always(function () {
            (void 0 === o ? fe(e).removeProp(s) : (e[s] = o),
    ...
    (de.createHTMLDocument =
      (((Gt = Z.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (fe.fn.load = function (e, t, i) {
      var n,
        ...
        r = e.indexOf(" ");
      return (
        -1 < r && ((n = W(e.slice(r))), (e = e.slice(0, r))),
        ce(t)
          ? ((i = t), (t = void 0))
    ...
    (fe.offset = {
      setOffset: function (e, t, i) {
        ...
        ("static" === d && (e.style.position = "relative"),
          ...
          ce(t) && (t = t.call(e, i, fe.extend({}, r))),
          null != t.top && (u.top = t.top - r.top + a),
        ...
        if (this[0]) {
          ...
          if ("fixed" === fe.css(n, "position")) t = n.getBoundingClientRect();
            ...
            e &&
              e !== n &&
              1 === e.nodeType &&
              (((s = fe(e).offset()).top += fe.css(e, "borderTopWidth", !0)),
              (s.left += fe.css(e, "borderLeftWidth", !0)));
          }
          return {
        ...
        fe.fn[e] = function (n) {
          return Pe(
            ...
            function (e, n, s) {
              var o;
              if (
                (ue(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView),
                void 0 === s)
              )
                return o ? o[t] : e[n];
              o
    ...
    fe.each(["top", "left"], function (e, t) {
      fe.cssHooks[t] = D(de.pixelPosition, function (e, i) {
        if (i)
          return ((i = z(e, t)), ot.test(i) ? fe(e).position()[t] + "px" : i);
      });
    }),
      ...
      return (
        (s = n.cache[e]
          ...
          : v.test(e)
            ...
            : n.createElem(e)),
        !s.canHaveChildren || f.test(e) || s.tagUrn ? s : n.frag.appendChild(s)
      );
    }
    function r(e, i) {
      if ((e || (e = t), u)) return e.createDocumentFragment();
      i = i || o(e);
      for (var s = i.frag.cloneNode(), a = 0, r = n(), l = r.length; l > a; a++)
        s.createElement(r[a]);
      return s;
    }
    function l(e, t) {
    ...
    ((t = (function () {
      ...
      (t.prototype.checkResponsive = function (t, i) {
        ...
        if (
          ("window" === a.respondTo
            ...
            : "slider" === a.respondTo
              ? (o = l)
              : "min" === a.respondTo && (o = Math.min(d, l)),
              ...
              o.slideCount % o.options.slidesToScroll != 0 &&
                ...
                (e > o.slideCount
                  ...
                  : ((o.slideOffset =
                      ...
                      o.slideWidth *
                      -1),
                    (a = (o.slideCount % o.options.slidesToScroll) * i * -1))))
        ...
        if (
          (!0 === a.options.centerMode
            ? !0 === a.options.infinite
              ? ((s = a.currentSlide + (a.options.slidesToShow / 2 + 1)),
                (o = s + a.options.slidesToShow + 2))
              : ((s = Math.max(
                  0,
                  a.currentSlide - (a.options.slidesToShow / 2 + 1),
                )),
                (o = a.options.slidesToShow / 2 + 1 + 2 + a.currentSlide))
            : ((s = a.options.infinite
                ? a.options.slidesToShow + a.currentSlide
                : a.currentSlide),
              (o = Math.ceil(s + a.options.slidesToShow)),
              !0 === a.options.fade &&
                (s > 0 && s--, o <= a.slideCount && o++)),
          (i = a.$slider.find(".slick-slide").slice(s, o)),
          "anticipated" === a.options.lazyLoad)
        )
          for (
            var r = s - 1, l = o, d = a.$slider.find(".slick-slide"), c = 0;
            ...
            for (i in s)
              if ("array" !== e.type(a.options.responsive))
                ...
                for (t = a.options.responsive.length - 1; t >= 0; )
                  (a.options.responsive[t].breakpoint === s[i].breakpoint &&
      ...
      (t.prototype.selectHandler = function (t) {
        ...
        if ((s || (s = 0), i.slideCount <= i.options.slidesToShow))
          return void i.slideHandler(s, !1, !0);
        i.slideHandler(s);
      }),
  ...
  (function (e, t) {
          ...
          if (a.indexOf("<") >= 0 && a.indexOf(">") >= 0) {
            ...
            for (
              0 === a.indexOf("<li") && (r = "ul"),
                ...
                (o = d.createElement(r)).innerHTML = a,
                n = 0;
            ...
            for (
              ...
              s[n] && i.push(s[n]);
        } else if (e.nodeType || e === c || e === d) i.push(e);
      ...
      if ((a.originalEvent && (a = a.originalEvent), i.isTouched)) {
        if (!i.isTouchEvent || "mousemove" !== a.type) {
          var r =
            ...
            c = "touchmove" === a.type ? r.pageY : a.pageY;
              ...
              if (
                (void 0 === i.isScrolling &&
                  ...
                  (this.isVertical() && s.currentX === s.startX)
                    ...
                    : u * u + p * p >= 25 &&
                      ((f =
                        (180 * Math.atan2(Math.abs(p), Math.abs(u))) / Math.PI),
    ...
    function s(e) {
      ...
      if (
        ...
        if (n.freeMode) {
          ...
          for (
            var $ = 0, P = t.slidesSizesGrid[0], M = 0;
            M < r.length;
            M += n.slidesPerGroup
          )
            void 0 !== r[M + n.slidesPerGroup]
              ? c >= r[M] &&
                ...
                (($ = M), (P = r[M + n.slidesPerGroup] - r[M]))
              : c >= r[M] && (($ = M), (P = r[r.length - 1] - r[r.length - 2]));
          var L = (c - r[$]) / P;
          if (p > n.longSwipesMs) {
            if (!n.longSwipes) return void t.slideTo(t.activeIndex);
            ("next" === t.swipeDirection &&
              (L >= n.longSwipesRatio
                ? t.slideTo($ + n.slidesPerGroup)
                : t.slideTo($)),
            ...
            (d.target !== t.navigation.nextEl &&
              ...
              ? ("next" === t.swipeDirection && t.slideTo($ + n.slidesPerGroup),
    ...
    var p = {
        ...
        function t(t) {
          ...
          if (i) {
            ...
            if ((n.indexOf(t) < 0 && n.unshift(t), e(i).is(r))) l.apply(i, n);
              ...
              for (var s = e(i).parents(), o = 0; o < s.length; o += 1)
                e(s[o]).is(r) && l.apply(s[o], n);
          }
        }
        function i(e) {
        ...
        for (var i = e[0].split(" "), n = e[1], s = 0; s < i.length; s += 1)
          for (var o = i[s], a = 0; a < this.length; a += 1) {
            var r = this[a],
              l = void 0;
            try {
              l = new c.CustomEvent(o, {
                detail: n,
                bubbles: !0,
                cancelable: !0,
              });
            } catch (e) {
              ((l = d.createEvent("Event")).initEvent(o, !0, !0),
                (l.detail = n));
            }
      ...
      parent: function (i) {
        for (var n = [], s = 0; s < this.length; s += 1)
          null !== this[s].parentNode &&
            (i
              ? e(this[s].parentNode).is(i) && n.push(this[s].parentNode)
      ...
      parents: function (i) {
        for (var n = [], s = 0; s < this.length; s += 1)
          for (var o = this[s].parentNode; o; )
            (i ? e(o).is(i) && n.push(o) : n.push(o), (o = o.parentNode));
        return e(t(n));
      },
      closest: function (e) {
        var t = this;
      ...
      children: function (i) {
        for (var n = [], s = 0; s < this.length; s += 1)
          for (var o = this[s].childNodes, a = 0; a < o.length; a += 1)
            i
              ? 1 === o[a].nodeType && e(o[a]).is(i) && n.push(o[a])
              : 1 === o[a].nodeType && n.push(o[a]);
        return new u(t(n));
      },
      filter: function (e) {
        for (var t = [], i = 0; i < this.length; i += 1)
      ...
      add: function () {
        ...
        for (n = 0; n < t.length; n += 1) {
          ...
          for (s = 0; s < o.length; s += 1)
            ((this[this.length] = o[s]), (this.length += 1));
        }
        return this;
      },
      styles: function () {
          ...
          for (var i = Object(e[0]), n = 1; n < e.length; n += 1) {
            ...
            if (null != s)
              for (
                ...
                void 0 !== d &&
                  d.enumerable &&
                  (h.isObject(i[l]) && h.isObject(s[l])
                    ? h.extend(i[l], s[l])
                    : !h.isObject(i[l]) && h.isObject(s[l])
                      ? ((i[l] = {}), h.extend(i[l], s[l]))
                      : (i[l] = s[l]));
              }
          }
          return i;
    ...
    ((v.prototype.on = function (e, t, i) {
      ...
      (v.prototype.once = function (e, t, i) {
        function n() {
      ...
      (v.prototype.emit = function () {
        ...
        return o.eventsListeners
          ? ("string" == typeof e[0] || Array.isArray(e[0])
              ? ((i = e[0]), (n = e.slice(1, e.length)), (s = o))
              : ((i = e[0].events), (n = e[0].data), (s = e[0].context || o)),
      ...
      (v.installModule = function (e) {
        ...
        var s =
          e.name || Object.keys(n.prototype.modules).length + "_" + h.now();
        return (
    ...
    var m,
      ...
      z = {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== n) {
            ...
            for (
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  var I = Math.floor(
                    ...
                    O = M - t.slidesPerColumn * t.slidesPerGroup * I;
                  ((A =
                    (z =
                      O -
                      (D = Math.floor(O / t.slidesPerGroup)) *
                        t.slidesPerGroup +
                      I * t.slidesPerGroup) +
                    (D * S) / k),
                    L.css({
              ...
              if ("none" !== L.css("display")) {
                if ("auto" === t.slidesPerView) {
                  var H = c.getComputedStyle(L[0], null),
                  ...
                  if (
                    ...
                    var F = parseFloat(H.getPropertyValue("width")),
                      ...
                      B = parseFloat(H.getPropertyValue("margin-left")),
                      X = parseFloat(H.getPropertyValue("margin-right")),
                      W = H.getPropertyValue("box-sizing");
                    C = W && "border-box" === W ? F + B + X : F + q + R + B + X;
                  } else {
                    var Y = parseFloat(H.getPropertyValue("height")),
                      V = parseFloat(H.getPropertyValue("padding-top")),
                      G = parseFloat(H.getPropertyValue("padding-bottom")),
                      _ = parseFloat(H.getPropertyValue("margin-top")),
                      U = parseFloat(H.getPropertyValue("margin-bottom")),
                      K = H.getPropertyValue("box-sizing");
                    C = K && "border-box" === K ? Y + _ + U : Y + V + G + _ + U;
                  }
                  (N && (L[0].style.transform = N),
                    j && (L[0].style.webkitTransform = j),
                    t.roundLengths && (C = Math.floor(C)));
                } else
                  ((C = (n - (t.slidesPerView - 1) * b) / t.slidesPerView),
                    t.roundLengths && (C = Math.floor(C)),
                    l[M] &&
                      (this.isHorizontal()
                        ? (l[M].style.width = C + "px")
                        : (l[M].style.height = C + "px")));
                (l[M] && (l[M].swiperSlideSize = C),
                  f.push(C),
                  t.centeredSlides
                    ? ((w = w + C / 2 + x / 2 + b),
                      0 === x && 0 !== M && (w = w - n / 2 - b),
            ...
            if (
              ...
              for (var Q = 0; Q < u.length; Q += 1) {
                ...
                (t.roundLengths && (Z = Math.floor(Z)),
                  u[Q] < this.virtualSize + u[0] && E.push(Z));
              }
              u = E;
            }
            if (!t.centeredSlides) {
              ...
              for (var J = 0; J < u.length; J += 1) {
                ...
                (t.roundLengths && (ee = Math.floor(ee)),
                  u[J] <= this.virtualSize - n && E.push(ee));
              }
              ((u = E),
                Math.floor(this.virtualSize - n) - Math.floor(u[u.length - 1]) >
                  1 && u.push(this.virtualSize - n));
            }
            if (
              (0 === u.length && (u = [0]),
              0 !== t.spaceBetween &&
                (this.isHorizontal()
                  ? s
                    ? l.filter(e).css({ marginLeft: b + "px" })
                    : l.filter(e).css({ marginRight: b + "px" })
                  : l.filter(e).css({ marginBottom: b + "px" })),
            ...
            (h.extend(this, {
              ...
              d !== r && this.emit("slidesLengthChange"),
              u.length !== m &&
          ...
          if (0 !== n.length) {
            ...
            for (var a = 0; a < n.length; a += 1) {
              var r = n[a],
                l =
                  (o +
                    (i.centeredSlides ? this.minTranslate() : 0) -
                    r.swiperSlideOffset) /
        ...
        updateProgress: function (e) {
          ...
          (0 === n
            ? ((s = 0), (o = !0), (a = !0))
            : ((o = (s = (e - this.minTranslate()) / n) <= 0), (a = s >= 1)),
            h.extend(this, { progress: s, isBeginning: o, isEnd: a }),
            (i.watchSlidesProgress || i.watchSlidesVisibility) &&
              this.updateSlidesProgress(e),
            o && !r && this.emit("reachBeginning toEdge"),
            a && !l && this.emit("reachEnd toEdge"),
            ((r && !o) || (l && !a)) && this.emit("fromEdge"),
      ...
      O = {
        slideTo: function (e, t, i, n) {
          ...
          if ((o.updateProgress(g), r.normalizeSlideIndex))
            for (var m = 0; m < d.length; m += 1)
              -Math.floor(100 * g) >= Math.floor(100 * d[m]) && (a = m);
          ...
          if (
            ...
            return (
              ...
              "slide" !== r.effect && o.setTranslate(g),
        ...
        slideNext: function (e, t, i) {
          ...
          return n.loop
            ? !s &&
                ...
                this.slideTo(this.activeIndex + n.slidesPerGroup, e, t, i))
            : this.slideTo(this.activeIndex + n.slidesPerGroup, e, t, i);
        },
        slidePrev: function (e, t, i) {
          ...
          var d,
            c = n(l ? this.translate : -this.translate),
            u = a.map(function (e) {
              return n(e);
            }),
            p =
        ...
        slideToClickedSlide: function () {
          ...
          if (n.loop) {
            ...
            ((t = parseInt(
              ...
              n.centeredSlides
                ? a < i.loopedSlides - o / 2 ||
                  a > i.slides.length - i.loopedSlides + o / 2
                  ? (i.loopFix(),
                    (a = s
                      .children(
                        "." +
        ...
        loopCreate: function () {
          ...
          if (i.loopFillGroupWithBlank) {
            ...
            if (o !== i.slidesPerGroup) {
              for (var a = 0; a < o; a += 1) {
                var r = e(d.createElement("div")).addClass(
          ...
          s.each(function (i, n) {
            ...
            (i < t.loopedSlides && c.push(n),
              i < s.length && i >= s.length - t.loopedSlides && l.push(n),
      ...
      j = {
        ...
        addSlide: function (e, t) {
          ...
          if (e <= 0) this.prependSlide(t);
            ...
            for (var a = s > e ? s + 1 : s, r = [], l = o - 1; l >= e; l -= 1) {
      ...
      F =
        ((m = c.navigator.platform),
        (y = c.navigator.userAgent),
        (b = {
          ios: !1,
          android: !1,
          androidChrome: !1,
        ...
        (w = c.screen.width),
        (x = c.screen.height),
        (T = y.match(/(Android);?[\s\/]+([\d.]+)?/)),
        (S = y.match(/(iPad).*OS\s([\d_]+)/)),
        (C = y.match(/(iPod)(.*OS\s([\d_]+))?/)),
        (E = !S && y.match(/(iPhone\sOS|iOS)\s([\d_]+)/)),
        (k = y.indexOf("MSIE ") >= 0 || y.indexOf("Trident/") >= 0),
        ($ = y.indexOf("Edge/") >= 0),
        (P = y.indexOf("Gecko/") >= 0 && y.indexOf("Firefox/") >= 0),
        (M = "Win32" === m),
        (L = y.toLowerCase().indexOf("electron") >= 0),
        (A = "MacIntel" === m),
        !S &&
          A &&
          f.touch &&
        ...
        T &&
          ...
          (b.osVersion = T[2]),
          (b.android = !0),
          (b.androidChrome = y.toLowerCase().indexOf("chrome") >= 0)),
        (S || E || C) && ((b.os = "ios"), (b.ios = !0)),
        E && !C && ((b.osVersion = E[2].replace(/_/g, ".")), (b.iphone = !0)),
        S && ((b.osVersion = S[2].replace(/_/g, ".")), (b.ipad = !0)),
        C &&
          ((b.osVersion = C[3] ? C[3].replace(/_/g, ".") : null),
          (b.ipod = !0)),
        b.ios &&
          b.osVersion &&
          y.indexOf("Version/") >= 0 &&
          "10" === b.osVersion.split(".")[0] &&
          (b.osVersion = y.toLowerCase().split("version/")[1].split(" ")[0]),
        (b.webView =
          !(
            !(E || S || C) ||
            (!y.match(/.*AppleWebKit(?!.*Safari)/i) && !c.navigator.standalone)
          ) ||
          (c.matchMedia && c.matchMedia("(display-mode: standalone)").matches)),
        (b.webview = b.webView),
        (b.standalone = b.webView),
        (b.desktop = !(b.ios || b.android) || L),
        b.desktop &&
          ((b.electron = L),
          (b.macos = A),
          (b.windows = M),
        ...
        (b.pixelRatio = c.devicePixelRatio || 1),
        b),
      q = !1,
      R = {
        init: !0,
        ...
        events: {
          attachEvents: function () {
            ...
            if (!f.touch && f.pointerEvents)
              (c.addEventListener(t.start, this.onTouchStart, !1),
                d.addEventListener(t.move, this.onTouchMove, p),
              ...
              if (f.touch) {
                ...
                (c.addEventListener(t.start, this.onTouchStart, h),
                  c.addEventListener(
                    t.move,
                    this.onTouchMove,
                    f.passiveListener ? { passive: !1, capture: p } : p,
                  ),
                  c.addEventListener(t.end, this.onTouchEnd, h),
                  t.cancel && c.addEventListener(t.cancel, this.onTouchEnd, h),
                  q || (d.addEventListener("touchstart", l), (q = !0)));
              }
              ((e.simulateTouch && !F.ios && !F.android) ||
                (e.simulateTouch && !f.touch && F.ios)) &&
                (c.addEventListener("mousedown", this.onTouchStart, !1),
                d.addEventListener("mousemove", this.onTouchMove, p),
            ...
            ((e.preventClicks || e.preventClicksPropagation) &&
              ...
              e.cssMode && u.addEventListener("scroll", this.onScroll),
              this.on(
                F.ios || F.android
          ...
          detachEvents: function () {
            ...
            if (!f.touch && f.pointerEvents)
              (i.removeEventListener(t.start, this.onTouchStart, !1),
                d.removeEventListener(t.move, this.onTouchMove, s),
              ...
              if (f.touch) {
                ...
                (i.removeEventListener(t.start, this.onTouchStart, a),
                  i.removeEventListener(t.move, this.onTouchMove, s),
                  i.removeEventListener(t.end, this.onTouchEnd, a),
                  t.cancel &&
                    i.removeEventListener(t.cancel, this.onTouchEnd, a));
              }
              ((e.simulateTouch && !F.ios && !F.android) ||
                (e.simulateTouch && !f.touch && F.ios)) &&
      ...
      W = (function (t) {
        function i() {
          for (var n, s, o, a = [], r = arguments.length; r--; )
            a[r] = arguments[r];
          ...
          (l.useModulesParams(d),
            (l.params = h.extend({}, d, X, o)),
            (l.originalParams = h.extend({}, l.params)),
            (l.passedParams = h.extend({}, o)),
            (l.$ = e));
          var c = e(l.params.el);
          if ((s = c[0])) {
            if (c.length > 1) {
            ...
            return (
              ...
              s && s.shadowRoot && s.shadowRoot.querySelector
                ...
                : (p = c.children("." + l.params.wrapperClass)),
              h.extend(l, {
                $el: c,
                el: s,
                $wrapperEl: p,
                ...
                touchEvents:
                  ...
                  f.touch || !l.params.simulateTouch
                    ? l.touchEventsTouch
                    : l.touchEventsDesktop),
                touchEventsData: {
                  isTouched: void 0,
        ...
        return (
          (i.prototype.slidesPerViewDynamic = function () {
            ...
            if (e.centeredSlides) {
              for (
                var a, r = t[s].swiperSlideSize, l = s + 1;
                l < t.length;
                l += 1
              )
                t[l] &&
                  !a &&
                  ((o += 1), (r += t[l].swiperSlideSize) > n && (a = !0));
              for (var d = s - 1; d >= 0; d -= 1)
                t[d] &&
                  !a &&
                  ((o += 1), (r += t[d].swiperSlideSize) > n && (a = !0));
            } else
      ...
      Y = { name: "device", proto: { device: F }, static: { device: F } },
      V = { name: "support", proto: { support: f }, static: { support: f } },
      G = {
      ...
      _ = { name: "browser", proto: { browser: G }, static: { browser: G } },
      U = {
        name: "resize",
        create: function () {
          var e = this;
      ...
      Z = {
        update: function (e) {
          ...
          ((y = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top"),
            a
              ? ((b = Math.floor(s / 2) + o + l),
                (w = Math.floor(s / 2) + o + d))
              : ((b = s + (o - 1) + l), (w = o + d)));
          var T = Math.max((x || 0) - w, 0),
            S = Math.min((x || 0) + b, f.length - 1),
          ...
          if (
            ...
            return (
              i.slidesGrid !== v && C !== m && i.slides.css(y, C + "px"),
          ...
          if (i.params.virtual.renderExternal)
            return (
              i.params.virtual.renderExternal.call(i, {
                ...
                to: S,
                slides: (function () {
                  for (var e = [], t = T; t <= S; t += 1) e.push(f[t]);
                  return e;
                })(),
              }),
              void t()
          ...
          (k.forEach(function (e) {
            ...
            i.$wrapperEl.children(".swiper-slide").css(y, C + "px"),
            t());
        },
        renderSlide: function (t, i) {
          ...
          return (
            ...
            n.cache && (this.virtual.cache[i] = s),
            s
          );
        },
        appendSlide: function (e) {
        ...
        on: {
          beforeInit: function () {
            if (this.params.virtual.enabled) {
              ...
              (h.extend(this.params, e),
                h.extend(this.originalParams, e),
      ...
      ee = {
        ...
        enable: function () {
          this.keyboard.enabled ||
            (e(d).on("keydown", this.keyboard.handle),
            (this.keyboard.enabled = !0));
        },
        disable: function () {
          this.keyboard.enabled &&
            (e(d).off("keydown", this.keyboard.handle),
      ...
      ie = {
        ...
        disable: function () {
          ...
          if (this.params.cssMode)
            return (
              this.wrapperEl.addEventListener(t, this.mousewheel.handle),
              !0
            );
          if (!t) return !1;
          if (!this.mousewheel.enabled) return !1;
          ...
          return (
            "container" !== this.params.mousewheel.eventsTarged &&
              (i = e(this.params.mousewheel.eventsTarged)),
            i.off(t, this.mousewheel.handle),
          ...
          if (
              ...
              if (
                (i.dynamicBullets &&
                  ...
                  o.css(
                    ...
                    this.pagination.bulletSize * (i.dynamicMainBullets + 4) +
                      "px",
                  ),
                  ...
                  (d =
                    ((l = r + (Math.min(c.length, i.dynamicMainBullets) - 1)) +
                      r) /
                    2)),
                c.removeClass(
                  i.bulletActiveClass +
                ...
                c.each(function (t, s) {
                  var o = e(s),
                    a = o.index();
                  (a === n && o.addClass(i.bulletActiveClass),
                    i.dynamicBullets &&
                      (a >= r &&
                        a <= l &&
                ...
                if ((u.addClass(i.bulletActiveClass), i.dynamicBullets)) {
                  for (var h = c.eq(r), f = c.eq(l), v = r; v <= l; v += 1)
            ...
            if (
              ("fraction" === i.type &&
                ...
                o.find("." + i.totalClass).text(i.formatFractionTotal(a))),
              "progressbar" === i.type)
            ) {
              var w;
            ...
            ("custom" === i.type && i.renderCustom
              ? (o.html(i.renderCustom(this, n + 1, a)),
                this.emit("paginationRender", this, o[0]))
              : this.emit("paginationUpdate", this, o[0]),
              o[
                this.params.watchOverflow && this.isLocked
                  ? "addClass"
                  : "removeClass"
          ...
          if (
            ...
            if ("bullets" === e.type) {
              for (
                ...
                e.renderBullet
                  ? (n += e.renderBullet.call(this, o, e.bulletClass))
                  : (n +=
                      "<" +
                      e.bulletElement +
                      ' class="' +
        ...
        init: function () {
          ...
          if (i.el) {
            ...
            0 !== n.length &&
              ...
              h.extend(t.pagination, { $el: n, el: n[0] }));
          }
        },
        destroy: function () {
          var e = this.params.pagination;
      ...
      oe = {
        ...
        enableDraggable: function () {
          if (this.params.scrollbar.el) {
            var e = this.scrollbar,
              ...
              n = this.params,
              s = e.$el[0],
              o = !(!f.passiveListener || !n.passiveListeners) && {
                passive: !1,
                capture: !1,
              },
              a = !(!f.passiveListener || !n.passiveListeners) && {
                passive: !0,
                capture: !1,
              };
            f.touch
              ? (s.addEventListener(t.start, this.scrollbar.onDragStart, o),
                s.addEventListener(t.move, this.scrollbar.onDragMove, o),
                s.addEventListener(t.end, this.scrollbar.onDragEnd, a))
              : (s.addEventListener(i.start, this.scrollbar.onDragStart, o),
                d.addEventListener(i.move, this.scrollbar.onDragMove, o),
                d.addEventListener(i.end, this.scrollbar.onDragEnd, a));
          }
        },
        disableDraggable: function () {
          if (this.params.scrollbar.el) {
            ...
            f.touch
              ? (s.removeEventListener(t.start, this.scrollbar.onDragStart, o),
                s.removeEventListener(t.move, this.scrollbar.onDragMove, o),
                s.removeEventListener(t.end, this.scrollbar.onDragEnd, a))
              : (s.removeEventListener(i.start, this.scrollbar.onDragStart, o),
                d.removeEventListener(i.move, this.scrollbar.onDragMove, o),
                d.removeEventListener(i.end, this.scrollbar.onDragEnd, a));
          }
        },
        init: function () {
          if (this.params.scrollbar.el) {
            ...
            (0 === o.length &&
              ...
              s.append(o)),
              h.extend(t, { $el: s, el: s[0], $dragEl: o, dragEl: o[0] }),
        ...
        onGestureStart: function (t) {
          ...
          if (
            ...
            ((n.fakeGestureTouched = !0),
              (s.scaleStart = re.getDistanceBetweenTouches(t)));
          }
        ...
        onGestureChange: function (e) {
          ...
          if (!f.gestures) {
            ...
            ((i.fakeGestureMoved = !0),
              (n.scaleMove = re.getDistanceBetweenTouches(e)));
          }
          n.$imageEl &&
            0 !== n.$imageEl.length &&
            (f.gestures
        ...
        onTouchMove: function (e) {
          ...
          if (
            ...
            if (!(o < i.slideWidth && a < i.slideHeight)) {
              if (
                ((n.minX = Math.min(i.slideWidth / 2 - o / 2, 0)),
                (n.maxX = -n.minX),
            ...
            w.$imageEl &&
              ...
              t
                ? ((g = w.$slideEl[0].offsetWidth),
                  ...
                  (s = w.$slideEl.offset().left + g / 2 - i),
                  (o = w.$slideEl.offset().top + m / 2 - n),
                  (l = w.$imageEl[0].offsetWidth),
                  (d = w.$imageEl[0].offsetHeight),
                  (c = l * y.scale),
                  (u = d * y.scale),
                  (f = -(p = Math.min(g / 2 - c / 2, 0))),
                  (v = -(h = Math.min(m / 2 - u / 2, 0))),
                  (a = s * y.scale) < p && (a = p),
                  a > f && (a = f),
                  (r = o * y.scale) < h && (r = h),
                  r > v && (r = v))
              ...
              0 !== a.length &&
                a.each(function (t, a) {
                  ...
                  var l = r.attr("data-background"),
                    ...
                    u = r.attr("data-sizes");
                  (n.loadImage(r[0], d || l, c, u, !1, function () {
        ...
        load: function () {
          function t(e) {
            if (l) {
              if (
                s.children(
                  "." + o.slideClass + '[data-swiper-slide-index="' + e + '"]',
                ).length
              )
                return !0;
          ...
          if (
            ...
            s.children("." + o.slideVisibleClass).each(function (t, i) {
              var s = l ? e(i).attr("data-swiper-slide-index") : e(i).index();
              n.lazy.loadInSlide(s);
            });
          else if (c > 1)
            for (var u = r; u < r + c; u += 1) t(u) && n.lazy.loadInSlide(u);
            ...
            if (c > 1 || (d.loadPrevNextAmount && d.loadPrevNextAmount > 1)) {
              for (
                var p = d.loadPrevNextAmount,
                  h = c,
                  f = Math.min(r + h + Math.max(p, h), a.length),
                  v = Math.max(r - Math.max(h, p), 0),
                  g = r + c;
                g < f;
                g += 1
              )
                t(g) && n.lazy.loadInSlide(g);
              for (var m = v; m < r; m += 1) t(m) && n.lazy.loadInSlide(m);
            } else {
        ...
        setTranslate: function (e, t) {
          function i(e) {
            ...
            ("slide" === o.params.controller.by &&
              ...
              (s && "container" !== o.params.controller.by) ||
                ...
                (s = (t - o.minTranslate()) * n + e.minTranslate())),
          ...
          if (Array.isArray(a))
            for (var r = 0; r < a.length; r += 1)
              a[r] !== t && a[r] instanceof W && i(a[r]);
          else a instanceof W && t !== a && i(a);
        },
        setTransition: function (e, t) {
          function i(t) {
            (t.setTransition(e, s),
          ...
          if (Array.isArray(o))
            for (n = 0; n < o.length; n += 1)
              o[n] !== t && o[n] instanceof W && i(o[n]);
          else o instanceof W && t !== o && i(o);
        },
      },
      ce = {
          ...
          t.pagination &&
            ...
            t.pagination.bullets.each(function (n, s) {
              ...
              (t.a11y.makeElFocusable(o),
                ...
                t.a11y.addElLabel(
                  o,
                  i.paginationBulletMessage.replace(/{{index}}/, o.index() + 1),
                ));
            });
        },
        init: function () {
      ...
      ue = {
        ...
        setHistoryPopState: function () {
          ((this.history.paths = ue.getPathValues()),
        ...
        setHistory: function (e, t) {
          if (this.history.initialized && this.params.history.enabled) {
            var i = this.slides.eq(t),
              n = ue.slugify(i.attr("data-history"));
            c.location.pathname.includes(e) || (n = e + "/" + n);
            var s = c.history.state;
            (s && s.value === n) ||
              (this.params.history.replaceState
        ...
        scrollToSlide: function (e, t, i) {
          if (t)
            for (var n = 0, s = this.slides.length; n < s; n += 1) {
              ...
              if (
                ue.slugify(o.attr("data-history")) === t &&
        ...
        init: function () {
          if (
            ...
            this.params.hashNavigation.watchState &&
              e(c).on("hashchange", this.hashNavigation.onHashCange);
          }
        },
        destroy: function () {
          this.params.hashNavigation.watchState &&
            e(c).off("hashchange", this.hashNavigation.onHashCange);
        },
      },
      he = {
        run: function () {
      ...
      ge = {
        setTranslate: function () {
          for (
            var t = this.slides, i = this.rtlTranslate, n = 0;
            n < t.length;
            n += 1
          ) {
            var s = t.eq(n),
      ...
      me = {
        setTranslate: function () {
          for (
            ...
            var v = n.eq(p),
              g = o[p],
              m = ((d - v[0].swiperSlideOffset - g / 2) / g) * a.modifier,
              y = r ? c * m : 0,
              b = r ? 0 : c * m,
              w = -u * Math.abs(m),
              x = r ? 0 : a.stretch * m,
        ...
        init: function () {
          ...
          (e.swiper instanceof t
            ? ((this.thumbs.swiper = e.swiper),
              h.extend(this.thumbs.swiper.originalParams, {
        ...
        onThumbClick: function () {
          ...
          if (t) {
            ...
            if (
              !(
                (n &&
                  e(n).hasClass(this.params.thumbs.slideThumbActiveClass)) ||
                null == i
              )
            ) {
              var s;
              if (
                ...
                this.slides.eq(o).hasClass(this.params.slideDuplicateClass) &&
                  (this.loopFix(),
                  (this._clientLeft = this.$wrapperEl[0].clientLeft),
                  (o = this.activeIndex));
                var a = this.slides
          ...
          on: {
            ...
            click: function (t) {
              ...
              !this.params.navigation.hideOnClick ||
                ...
                e(t.target).is(s) ||
                (s
                  ? (i = s.hasClass(this.params.navigation.hiddenClass))
    ...
    e.fn.downCount = function (t, i) {
      function n() {
        var e = new Date(s.date),
          ...
          n = e - t;
        if (n < 0)
          return (clearInterval(r), void (i && "function" == typeof i && i()));
        var l = 1e3,
          d = 60 * l,
          c = 60 * d,
          u = 24 * c,
        ...
        var y = 1 === f ? "day" : "days",
          b = 1 === v ? "hour" : "hours",
          w = 1 === g ? "minute" : "minutes",
          x = 1 === m ? "second" : "seconds";
        (o.find(".month").text(h),
          o.find(".days").text(f),
          o.find(".hours").text(v),
          o.find(".minutes").text(g),
          o.find(".seconds").text(m),
          o.find(".month_ref").text("month"),
          o.find(".days_ref").text(y),
          o.find(".hours_ref").text(b),
          o.find(".minutes_ref").text(w),
          o.find(".seconds_ref").text(x));
      }
      var s = e.extend({ date: null, offset: null }, t);
      (s.date || e.error("Date is not defined."),
        Date.parse(s.date) ||
          e.error(
      ...
      var o = this,
        a = function () {
          ...
          return new Date(t + 36e5 * s.offset);
        },
        r = setInterval(n, 1e3);
    };
  })(jQuery),
      ...
      var o = {
        ...
        g = function (e, t, n) {
          ...
          ((s.opts = f({ index: n }, i.fancybox.defaults)),
            i.isPlainObject(t) && (s.opts = f(s.opts, t)),
      ...
      (i.extend(g.prototype, {
          ...
          (i.each(o, function (e, t) {
            ...
            (i.isPlainObject(t)
              ...
              : "object" === i.type(t) && i(t).length
                ? ((o = i(t)),
                  (u = o.data() || {}),
                  (u = i.extend(!0, {}, u, u.options)),
                  (u.$orig = o),
                  (c.src = s.opts.src || u.src || o.attr("href")),
                  c.type || c.src || ((c.type = "inline"), (c.src = t)))
                : (c = { type: "html", src: t + "" }),
              (c.opts = i.extend(!0, {}, s.opts, u)),
                ...
                ((r = l.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
                  ...
                  : l.match(
                    ...
                    : l.match(/\.(pdf)((\?|#).*)?$/i)
                      ...
                      : "#" === l.charAt(0) && (a = "inline")),
              a ? (c.type = a) : s.trigger("objectNeedsType", c),
              c.contentType ||
                (c.contentType =
              ...
              "function" === i.type(c.opts.caption) &&
                (c.opts.caption = c.opts.caption.apply(t, [s, c])),
              "function" === i.type(s.opts.caption) &&
                (c.opts.caption = s.opts.caption.apply(t, [s, c])),
              ...
              "ajax" === c.type &&
                ((d = l.split(/\s+/, 2)),
                d.length > 1 &&
                  ((c.src = d.shift()), (c.opts.filter = d.shift()))),
              c.opts.modal &&
          ...
          (t.removeEvents(),
            ...
            r.on("keydown.fb", function (e) {
              var n = i.fancybox ? i.fancybox.getInstance() : null,
                s = n.current,
                o = e.keyCode || e.which;
              if (9 == o) return void (s.opts.trapFocus && t.focus(e));
              if (
                !(
                  !s.opts.keyboard ||
                  e.ctrlKey ||
        ...
        jumpTo: function (e, t) {
          ...
          if (!(f.isDragging || f.isClosing || (f.isAnimating && f.firstRun))) {
            ...
            if (
              ...
              (r = f.createSlide(e)),
              v > 1 &&
                ((a || r.index < v - 1) && f.createSlide(e + 1),
                (a || r.index > 0) && f.createSlide(e - 1)),
              (f.current = r),
              (f.currIndex = r.index),
              (f.currPos = r.pos),
              ...
              i.isNumeric(t)
                ? (r.forcedDuration = t)
                : (t = r.opts[s ? "animationDuration" : "transitionDuration"]),
              (t = parseInt(t, 10)),
              (o = f.isMoved(r)),
            ...
            ((d = i.fancybox.getTranslate(l.$slide)),
              ...
              o
                ? ((p = d.left - (l.pos * d.width + l.pos * l.opts.gutter)),
                  i.each(f.slides, function (e, n) {
                    ...
                    var s = n.pos * d.width + n.pos * n.opts.gutter;
                ...
                : t &&
                  ...
                  l.$slide.addClass(
                    "fancybox-slide--" + (l.pos > r.pos ? "next" : "previous"),
                  ),
                  i.fancybox.animate(
                    l.$slide,
                    u,
        ...
        createSlide: function (e) {
          ...
          return (
            ...
            !s.slides[e] &&
              ...
              (s.slides[e] = i.extend(!0, {}, s.group[n], {
                pos: e,
                $slide: t,
                isLoaded: !1,
              })),
        ...
        scaleToActual: function (e, t, s) {
          ...
          c.isAnimating ||
            ...
            (e = e === n ? 0.5 * h : e),
            (t = t === n ? 0.5 * f : t),
            (o = i.fancybox.getTranslate(p)),
            (o.top -= i.fancybox.getTranslate(u.$slide).top),
            ...
            i.fancybox.animate(
              p,
              { top: r, left: a, scaleX: l, scaleY: d },
              s || 366,
              function () {
                c.isAnimating = !1;
              },
        ...
        getFitPos: function (e) {
          ...
          return (
            ...
            ((t = i.fancybox.getTranslate(a.$refs.stage).width),
            (n = i.fancybox.getTranslate(a.$refs.stage).height),
            (t -=
            ...
            "image" === e.type
              ? ((u.top =
                  Math.floor(0.5 * (n - c)) + parseFloat(l.css("paddingTop"))),
                (u.left =
                  Math.floor(0.5 * (t - d)) + parseFloat(l.css("paddingLeft"))))
              : "video" === e.contentType &&
                ((o =
                  e.opts.width && e.opts.height
                    ? d / c
                    : e.opts.ratio || 16 / 9),
                c > d / o ? (c = d / o) : d > c * o && (d = c * o)),
            (u.width = d),
            (u.height = c),
            u)
          );
        ...
        updateSlide: function (e, t) {
          ...
          (n.adjustCaption(e),
            s &&
              (o || a || "video" === e.contentType) &&
              !e.hasError &&
              (i.fancybox.stop(s),
              i.fancybox.setTranslate(s, n.getFitPos(e)),
        ...
        isScaledDown: function (e, t) {
          ...
          return (
            e !== n && t !== n
              ? (o = e < a.width && t < a.height)
              : r &&
                ((o = i.fancybox.getTranslate(r)),
                (o = o.width < a.width && o.height < a.height)),
            o
          );
        },
        canPan: function (e, t) {
          ...
          return (
            "image" === o.type &&
              ...
              e !== n && t !== n
                ? (a = { width: e, height: t })
                : o.isComplete && (a = i.fancybox.getTranslate(o.$content)),
              a &&
                r &&
                (r =
        ...
        loadSlide: function (e) {
          ...
          if (!e.isLoading && !e.isLoaded) {
            if (((e.isLoading = !0), !1 === o.trigger("beforeLoad", e)))
                ...
                a.on("refresh.fb", function () {
                  ...
                  if (1 === t[0].isReady) {
                    ...
                    (s &&
                      ...
                      l === n &&
                        (l = Math.ceil(
                          Math.max(s[0].clientWidth, s.outerWidth(!0)),
                        )),
                      r.css("width", l || "").css("max-width", ""),
                      d === n &&
                        (d = Math.ceil(
                          Math.max(s[0].clientHeight, s.outerHeight(!0)),
                        )),
                      r.css("height", d || ""),
                      a.css("overflow", "auto")),
        ...
        revealContent: function (e) {
          ...
          return (
            ...
            (o = parseInt(e.forcedDuration === n ? o : e.forcedDuration, 10)),
            (!u && e.pos === r.currPos && o) || (t = !1),
            "zoom" === t &&
              (e.pos === r.currPos &&
              o &&
              "image" === e.type &&
            ...
            "zoom" === t
              ? ((r.isAnimating = !0),
                ...
                (a = e.opts.zoomOpacity),
                "auto" == a &&
                  (a = Math.abs(e.width / e.height - c.width / c.height) > 0.1),
                a && ((c.opacity = 0.1), (d.opacity = 1)),
                i.fancybox.setTranslate(
                  e.$content.removeClass("fancybox-is-hidden"),
                  c,
                ),
                h(e.$content),
                void i.fancybox.animate(e.$content, d, o, function () {
                ...
                t
                  ? (i.fancybox.stop(l),
                    ...
                    void i.fancybox.animate(
                      ...
                      o,
                      function () {
                        (l.removeClass(s).css({ transform: "", opacity: "" }),
        ...
        trigger: function (e, t) {
          ...
          if (
            ...
            return n;
          "afterClose" !== e && o.$refs
            ? o.$refs.container.trigger(e + ".fb", s)
            : r.trigger(e + ".fb", s);
        },
        updateControls: function () {
          ...
          (n.$slide.trigger("refresh"),
            ...
            o
              ...
              .prop("disabled", !n.opts.loop && s >= e.group.length - 1),
            "image" === n.type
              ? o
          ...
          setTranslate: function (e, t) {
            ...
            if (e && t)
              return (
                (t.left === n && t.top === n) ||
                  ((i =
                    (t.left === n ? e.position().left : t.left) +
                    "px, " +
                    (t.top === n ? e.position().top : t.top) +
                    "px"),
                  (i = this.use3d
                    ? "translate3d(" + i + ", 0px)"
                    : "translate(" + i + ")")),
                t.scaleX !== n && t.scaleY !== n
                  ? (i += " scale(" + t.scaleX + ", " + t.scaleY + ")")
                  : t.scaleX !== n && (i += " scaleX(" + t.scaleX + ")"),
                i.length && (s.transform = i),
                t.opacity !== n && (s.opacity = t.opacity),
                t.width !== n && (s.width = t.width),
                t.height !== n && (s.height = t.height),
                e.css(s)
              );
          },
          animate: function (e, t, s, o, a) {
            ...
            (i.isFunction(s) && ((o = s), (s = null)),
              ...
              e.on(p, function (d) {
                (!d ||
                  !d.originalEvent ||
                  (e.is(d.originalEvent.target) &&
                    "z-index" != d.originalEvent.propertyName)) &&
                  (l.stop(e),
                  i.isNumeric(s) && e.css("transition-duration", ""),
                  i.isPlainObject(t)
                    ? t.scaleX !== n &&
                      t.scaleY !== n &&
                      l.setTranslate(e, {
              ...
              i.isNumeric(s) && e.css("transition-duration", s + "ms"),
              i.isPlainObject(t)
                ? (t.scaleX !== n &&
                    t.scaleY !== n &&
                    (delete t.width,
        ...
        (function () {
          var e = ".fancybox-button",
            t = "fancybox-focus",
            n = null;
          r.on("mousedown mouseup focus blur", e, function (s) {
            switch (s.type) {
              case "mousedown":
                n = i(this);
                break;
  ...
  (function (e) {
    ...
    e(document).on("objectNeedsType.fb", function (n, s, o) {
      var a,
        ...
        h = o.src || "",
        f = !1;
      ((a = e.extend(!0, {}, t, o.opts.media)),
        e.each(a, function (t, n) {
          if ((l = h.match(n.matcher))) {
            if (
              ((f = n.type), (p = t), (u = {}), n.paramPlace && l[n.paramPlace])
            ) {
              ((c = l[n.paramPlace]),
                "?" == c[0] && (c = c.substring(1)),
                (c = c.split("&")));
            ...
            return (
              (d = e.extend(!0, {}, n.params, o.opts[t], u)),
              (h =
                "function" === e.type(n.url)
                  ? n.url.call(this, l, d, o)
                  : i(n.url, l, d)),
              (r =
                "function" === e.type(n.thumb)
                  ? n.thumb.call(this, l, d, o)
                  : i(n.thumb, l)),
              "youtube" === t
  ...
  (function (e, t, i) {
    ...
    ((c.prototype.destroy = function () {
        ...
        if (
          ...
          ((s.realPoints = s.startPoints = o(n)),
            s.startPoints.length &&
              ...
              (s.sliderStartPos = i.fancybox.getTranslate(p)),
        ...
        if (!0 !== l)
          ...
          if (
            ...
            r.group.length < 2 && a.opts.vertical
              ...
              : r.isDragging ||
                  !1 === a.opts.vertical ||
                  ("auto" === a.opts.vertical && i(e).width() > 800)
                ? (a.isSwiping = "x")
                : ((o = Math.abs(
      ...
      (c.prototype.onPan = function () {
        var e = this;
        if (a(e.newPoints[0], e.realPoints[0]) < (i.fancybox.isMobile ? 10 : 5))
      ...
      (c.prototype.limitMovement = function () {
        ...
        return (
          ...
          (n = Math.min(l - v, 0.5 * l - 0.5 * v)),
          d > 0 && s > e && (s = e - 1 + Math.pow(-e + p + d, 0.8) || 0),
      ...
      (c.prototype.limitPosition = function (e, t, i, n) {
        ...
        return (
          i > o
            ? ((e = e > 0 ? 0 : e), (e = e < o - i ? o - i : e))
            : (e = Math.max(0, o / 2 - i / 2)),
          n > a
      ...
      (c.prototype.onZoom = function () {
        var t = this,
          ...
          h = Math.floor(r * p),
          f = Math.floor(l * p),
          v = (r - h) * t.percentageOfImageAtPinchPointX,
          g = (l - f) * t.percentageOfImageAtPinchPointY,
          m = (t.newPoints[0].x + t.newPoints[1].x) / 2 - i(e).scrollLeft(),
          y = (t.newPoints[0].y + t.newPoints[1].y) / 2 - i(e).scrollTop(),
      ...
      (c.prototype.ontouchend = function (e) {
        ...
        ((n.speed = 100),
          ...
          r ? n.endPanning() : l ? n.endZooming() : n.endSwiping(a, d));
      }),
      (c.prototype.endSwiping = function (e, t) {
        ...
        ((n.sliderLastPos = null),
          "y" == e && !t && Math.abs(n.distanceY) > 50
            ...
            : r && n.distanceX > 0
              ? (s = n.instance.previous(l))
              : r && n.distanceX < 0 && (s = n.instance.next(l)),
      ...
      (c.prototype.endZooming = function () {
        ...
        o.contentLastPos &&
          ...
          (t = o.contentLastPos.top),
          (s = { top: t, left: e, width: r, height: l, scaleX: 1, scaleY: 1 }),
      ...
      (c.prototype.onTap = function (t) {
        var n,
          ...
          r = s.instance,
          l = r.current,
          d = (t && o(t)) || s.startPoints,
          c = d[0] ? d[0].x - i(e).scrollLeft() - s.stagePos.left : 0,
          u = d[0] ? d[0].y - i(e).scrollTop() - s.stagePos.top : 0,
          p = function (e) {
            var n = l.opts[e];
        ...
        if (
          ...
          if (s.tapped) {
            if (
              ...
              (s.tapped = null),
              Math.abs(c - s.tapX) > 50 || Math.abs(u - s.tapY) > 50)
            )
              return this;
            p("dblclick" + n);
          } else
    ...
    (t.extend(i.prototype, {
      ...
      set: function (e) {
        var i = this,
          n = i.instance,
          s = n.current;
        s && (!0 === e || s.opts.loop || n.currIndex < n.group.length - 1)
          ? i.isActive &&
            "video" !== s.contentType &&
            (i.$progress &&
              t.fancybox.animate(
    ...
    (t.extend(s.prototype, {
      ...
      focus: function (e) {
        ...
        s.instance.current &&
          ...
          (i = t.position()),
          "y" === s.opts.axis &&
          (i.top < 0 || i.top > o.height() - t.outerHeight())
            ? o.stop().animate({ scrollTop: o.scrollTop() + i.top }, e)
            : "x" === s.opts.axis &&
              (i.left < a.scrollLeft() ||
                i.left > a.scrollLeft() + (a.width() - t.outerWidth())) &&
              o.parent().stop().animate({ scrollLeft: i.left }, e));
      },
      update: function () {
        var e = this;
      ...
      t(e).on({
        "onInit.fb": function (e, t) {
          ...
          t &&
            !t.Thumbs &&
            ((i = new s(t)), i.isActive && !0 === i.opts.autoStart && i.show());
        },
        "beforeShow.fb": function (e, t, i, n) {
          var s = t && t.Thumbs;
      ...
      t(e).on("click", "[data-fancybox-share]", function () {
        ...
        o &&
          ("function" === t.type(o.opts.share.url) &&
            (e = o.opts.share.url.apply(o, [s, o])),
          (n = o.opts.share.tpl
            .replace(
              /\{\{media\}\}/g,
